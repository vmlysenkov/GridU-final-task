...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Total courses' duration is %d hours%n", coursesDurationOfStudent1);
        ...
        System.out.printf("Total courses' duration is %d hours%n", courseDurationOfStudent2);
